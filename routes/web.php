...
// Route::get('avaliacao/{product}/edit', [AvaliacaoController::class, 'edit'])->name('avaliacao.edit'); // Formulário de edição de produto
// Route::put('avaliacao/{product}', [AvaliacaoController::class, 'update'])->name('avaliacao.update');  // Atualizar um produto específico
